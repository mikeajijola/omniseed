...
With Node.js 22.13+, run `npm install`, `npm test`, then `npm run omniseed -- plan examples/minimal --json`. The example initially reports Customer Research as realised and Customer Support as missing.
