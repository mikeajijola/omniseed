...
test('runtime exposes the required domain operations',()=>assert.deepEqual(RUNTIME_OPERATIONS,['getCompany','listCapabilities','getCapability','listGaps','getCurrentPlan','generatePlan','cancelPlan','getState','listActivity','listObservations','listFindings','applyPlan']));
