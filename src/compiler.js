...
export function emptyRuntimeState(companyId = null) { return { version: 0, companyId, binding: { desiredRevision: null, observedRevision: null }, deployed: [], observed: [], evidence: [], history: [], plans: [], companyChanges: [], stewardshipControl: { state: "disabled", enabledAt: null, expiresAt: null, pausedAt: null }, stewardshipUsage: { active: 0, dailyChanges: 0, actions: 0, repairRounds: 0, day: null }, stewardshipObservations: [], stewardshipApprovals: [], stewardshipEvaluations: [] }; }
